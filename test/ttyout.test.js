...
const { colorVersion, ttyout } = require('../src/ttyout')
...
describe('#ttyout', function () {
  describe('colorVersion', function () {
    ;[
      ...
      { color: 'green', range: '^1.0.0', version: '1.2.3', wildcard: '^' },
      { color: 'green', range: '^1.0.0', version: '1.2.3', wildcard: '^' },
      { color: 'green', range: '1.x', version: '1.2.3', wildcard: '^' },
      { color: 'green', range: '1.x.0', version: '1.2.3', wildcard: '^' },
